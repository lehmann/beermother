...
export function buildBrewReport(a, o) {
    const r = o.props,
        ...
        s = d(r.targetVolumeL, 20) ? d(r.trubLossL) / d(r.targetVolumeL, 20) * 100 : 0,
        p = H(o.recipe),
        u = o.scaledFermentables.filter(t => t.use === "Mostura").reduce((t, M) => t + d(M.amountKg), 0),
        F = I(r, o.volumes).filter(t => d(t.totalG)).map(t => [t.name, `${n(t.mashG,1)} g`, `${n(t.spargeG,1)} g`, `${n(t.totalG,1)} g`]),
        f = k(r),
        b = readingLogRow(e("Pr\xE9-fervura"), o.volumes.preBoil, o.preBoilPlato, a.measurements.preBoil, f),
        x = readingLogRow(e("P\xF3s-fervura"), o.expected.hotPostBoil, o.postBoilPlato, a.measurements.postBoil, f),
        T = brewCorrectionCheckRows(a, o),
        S = O(a.phLog).map(t => [m(t.title), t.skipped && !t.readings ? e("pulado") : `pH ${n(t.finalPh,2)}`, t.totalMl > 0 ? `${n(t.totalMl,1)} mL` : "-"]);
    return {
        ...
        conditionRows: [
            ...
            [e("Evapora\xE7\xE3o"), `${n(r.evaporationPct,1)}%/h \xB7 ${w(r.evaporationLh,2)}`],
            [e("Perda de trub"), `${c(r.trubLossL,2)} \xB7 ${n(s,1)}%`],
            [e("Absor\xE7\xE3o dos gr\xE3os"), `${n(r.grainAbsorptionLkg,2)} L/kg`],
            [e("Rela\xE7\xE3o \xE1gua/malte"), `${n(r.waterToGrainRatioLkg,2)} L/kg`],
            [e("Malte total"), A(o.volumes.grainKg)]
        ],
        maltRows: o.scaledFermentables.map(t => [t.name, m(t.use), A(t.amountKg), t.use === "Mostura" && u ? `${n(t.amountKg/u*100,1)}%` : "-"]),
        mashAdditionRows: o.mashAdditions.map(t => [t.name, m(t.type), g(t.amount, t.unit), m(t.moment || t.use)]),
        originalWaterRows: [
        ...
        saltRows: F,
        readingRows: [b, x, [e("Fria / Trub"), `${c(o.expected.fermenterVolume,2)} ${e("fermentador")}`, coldReadingLog(a), "-"]],
        decisionRows: [
            [e("Pr\xE9-fervura"), b[1], b[2], h(o.preCorrection)],
            [e("P\xF3s-fervura"), x[1], x[2], h(o.postCorrection)],
            [e("Fria / Trub"), `${c(o.expected.fermenterVolume,2)} ${e("fermentador")}`, coldReadingLog(a), e("Registro final")]
        ],
        correctionRows: [correctionLogRow(e("Pr\xE9-fervura"), o.preCorrection), correctionLogRow(e("P\xF3s-fervura"), o.postCorrection)],
        ...
        parameterRows: [
            ...
            [e("Perda de trub"), `${c(r.trubLossL,2)} \xB7 ${n(s,1)}%`],
            [e("Absor\xE7\xE3o dos gr\xE3os"), `${n(r.grainAbsorptionLkg,2)} L/kg`],
            [e("Rela\xE7\xE3o \xE1gua/malte"), `${n(r.waterToGrainRatioLkg,2)} L/kg`], ...Math.abs(f - y) > 1e-4 ? [
                [e("Fator WRI"), n(f, 2)]
        ...
        boilRows: [
            [e("Tempo de fervura"), `${n(o.recipe.boilTimeMin,0)} min`]
        ],
        hopRows: o.boilAdditions.filter(t => t.kind === "hop").map(t => [t.name, g(t.amount, t.unit), `${n(t.plannedAlphaAcidPct,2)}%`, t.actualAlphaAcidPct === "" ? "-" : `${n(t.actualAlphaAcidPct,2)}%`, $(t)]),
        otherBoilAdditionRows: o.boilAdditions.filter(t => t.kind !== "hop").map(t => [t.name, m(t.type), g(t.amount, t.unit), $(t)]),
        additionRows: [...o.mashAdditions.map(t => [e("Mostura"), t.name, g(t.amount, t.unit), B(a, t, m(t.moment || t.use))]), ...o.boilAdditions.map(t => [e("Fervura"), t.name, g(t.amount, t.unit), B(a, t, $(t))]), ...(o.scaledYeasts || []).map(t => [e("Fermenta\xE7\xE3o"), t.name, C(t.amount, t.unit), e("Inocula\xE7\xE3o")])],
        timerEventRows: timerEventRows(a),
        yeastRows: (o.scaledYeasts || []).length ? o.scaledYeasts.map(t => [t.name, C(t.amount, t.unit)]) : [
            ["-", "-"]
        ],
        fermentationTitle: o.recipe.fermentationProfileName ? e("Perfil de fermenta\xE7\xE3o - {name}", {
            name: o.recipe.fermentationProfileName
        }) : e("Perfil de fermenta\xE7\xE3o"),
        fermentationRows: (o.recipe.fermentation || []).length ? o.recipe.fermentation.map(t => [t.name, K(t.temperatureC), Y(t.days)]) : [
            [e("Sem perfil no XML"), "-", "-"]
        ],
        ...
        analysisRows: [
            ...
            [e("Absor\xE7\xE3o dos gr\xE3os"), `${n(o.analysis.grainAbsorptionLkg,2)} L/kg`],
            [e("Evapora\xE7\xE3o"), `${n(o.analysis.evaporationPct,1)}%/h \xB7 ${w(o.analysis.evaporationLh,2)}`],
...
export function correctionRoundRows(a) {
    const o = a ? .correctionRounds || {},
        r = (i, l) => (Array.isArray(o[i]) ? o[i] : []).map(s => [l, e("{round}\xAA", {
            round: s.round
        }), m(s.action) || "-", s.checkWri === "" || s.checkWri === void 0 ? "-" : `${n(s.checkWri,1)} WRI`, formatTimerEventTime(s.at)]);
...
export function brewCorrectionCheckRows(a, o) {
    return [{
        ...
        if (!i || !i.wri || r.correction.status !== "ready" || r.correction.action === "Sem corre\xE7\xE3o") return [];
        const l = k(o.props),
            s = W(r.correction, i, r.expectedPlato, r.kind, o.props.evaporationLh, l),
            p = R({
                volumeL: r.correction.targetVolumeL,
                wri: i.wri
            }, l),
            u = `${n(i.wri,1)} WRI \xB7 ${n(p.realPlato,1)} \xB0P \xB7 ${p.sg.toFixed(3)}`;
        return [
            [r.label, `${n(r.expectedPlato,1)} \xB0P`, u || "-", [s.summary || s.title, s.detail].filter(Boolean).join(" \xB7 ")]
        ]
    })
}
export function timerEventRows(a) {
    return (a ? .timerEvents || []).map(o => [formatTimerEventTime(o.at), o.stage || "-", o.event || "-", o.detail || "-"])
}
export function formatTimerEventTime(a) {
    const o = new Date(a);
    return Number.isNaN(o.getTime()) ? "-" : o.toLocaleTimeString(V(), {
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit"
    })
...
export function readingLogRow(a, o, r, i, l = y) {
    const s = R(i, l),
        p = s.volumeL || s.wri ? `${s.volumeL?c(s.volumeL,2):"-"} \xB7 ${s.wri?`${n(s.wri,1)} WRI`:"-"}` : "-",
        u = s.realPlato ? `${n(s.realPlato,1)} \xB0P \xB7 ${s.sg.toFixed(3)}` : "-";
...
export function coldReadingLog(a) {
    const o = a.measurements.cold || {},
        ...
        i = o.fermenterVolumeL ? `${c(o.fermenterVolumeL,2)} ${e("fermentador")}` : "-";
    return `${r} \xB7 ${i}`
}
export function correctionLogRow(a, o) {
    const r = o.status === "pending" || o.action === "Sem corre\xE7\xE3o" ? "-" : c(Math.abs(o.deltaL), 2),
        i = o.extraBoilMin ? e("Fervura extra {min} min \xB7 IBU estimado {ibu}", {
            min: n(o.extraBoilMin, 1),
            ibu: o.estimatedIbu
        }) : r;
    return [a, o.status === "pending" ? e("Aguardando leitura") : m(o.action), c(o.targetVolumeL, 2), i]
}
...
<head>
  ...
  <title>${htmlEscape(e("Relat\xF3rio de Brassagem"))} - ${htmlEscape(r.title)}</title>
  <link href="${htmlEscape(P(U))}" rel="stylesheet">
  <style>
