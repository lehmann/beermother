          ...
          d(
            ...
            () => {
              (h(),
                Ye(e, { ...r }),
                b(
                  t('"{name}" salvo na sua biblioteca.', {
                    name: r.name,
                  }),
                ),
                n(r, !0));
...
function pn() {
  ...
  return a("section", "card anniversary-recipe-card", [
    a("div", "anniversary-recipe-mark", "11", {
      "aria-hidden": "true",
    }),
...
function In(e) {
  ...
  const f =
      (o.single
        ...
        : o.count === 1
          ? t("mediana de {n} leva no c\xE1lculo", {
              n: o.count,
            })
  ...
  const r = xe(),
    ...
    E = (g, q) => {
      g &&
        ...
        (c.session.calibrationSavedProfile = {
          id: g.id,
          name: g.name,
        }),
        b(q),
          ...
          d(
            ...
            () => {
              ...
              (g && pe() === g.id && re(g.params),
                E(
                  g,
                  t('"{name}" calibrado com esta brassagem.', {
                    name: r.name,
                  }),
                ));
            },
